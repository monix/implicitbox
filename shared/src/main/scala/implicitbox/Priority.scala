...
/**
  ...
  * ==Credits==
  *
  * `Priority` is a type copied from [[https://github.com/typelevel/algebra/ Algebra]],
  * authored by Erik Osheim.
  */
...
private[implicitbox] trait FindPreferred extends FindFallback {
  implicit def preferred[P](implicit ev: P): Priority[P, Nothing] =
    Priority.Preferred(ev)
}

private[implicitbox] trait FindFallback {
